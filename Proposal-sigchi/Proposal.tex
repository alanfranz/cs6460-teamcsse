...
So, we started thinking that maybe the problem is not one of implementation; it's not the university is unable to train graduates for the industry. We began thinking that, maybe, there is a \textbf{misalignment in incentives and expectations} for the various stakeholders: industry practitioners, university teachers, and students.\newline
 ...
 \section{Limitations}
 We will use our classmates at Educational Technology - Summer 2018 as our smaller group of people for the survey participants. We will use Piazza platform to share the survey. This can be a good model, since the students are from different background and experiences. However, for the larger group of people, there will be a limitation on finding a large number of participants that meet our group categories. It is more challenging to find a large number of teachers and professors, and also recruiters, since they have a busy schedule or they may not be allowed to participate in certain surveys due to the company policies. Additionally, it might be harder for the larger groups to ask them to participate on answering the survey questions.
  
 Another thing is time limitation. We only have 4-5 weeks to provide the survey questions, send it to the people (small and large group), validate the questions, and analyze and summerize the results. Sometimes, it takes a couple of weeks for each participant to only complete the survey and collect the results.
 
  
 \section{Deliverables}
 This table shows the deliverable due dates.
 
 \begin{table}[H]
 \centering
 \begin{tabular}{c r} 					% create two columns
 \hline\hline						% insert double line
 Deliverable & Due Dates (in 2018)\\
 \hline
 Five weekly status report & Every week, 06/25 - 07/23\\
...
\begin{itemize}
	...
	\begin{itemize}
	 	\item \textbf{Goal}: Create the online survey for the larger group of people and send it to them.
 		\item \textbf{Assignments Due}: Weekly Status Check 4, Intermediate Milestone 2
 		\item \textbf{Tasks}: Task 7
	\end{itemize} 
 \end{itemize} 
...
\begin{itemize}
	...
	\begin{itemize}
 		\item \textbf{Goal}: Collect the results and start providing Final project
