...
\def\plaintitle{Proposal\\Unaligned ?}
...
\begin{abstract}
  \textit{Abstract}-There is a widespread agreement that new graduates
  from computer science and software engineering does not always possess
  required skills, abilities or knowledge when joining software industry.
