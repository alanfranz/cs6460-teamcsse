...
Our question is: \textbf{does the perceived skill gap in fresh graduates exist because the academy is unable to provide a good training, or just because a) the academy is not even trying to do that kind of job, and b) the industry is taking that kind of job for granted, or c) the students think they should be getting something that the university has no intention to provide them with?}\newline
...
So, our hypothesis is that one of the reasons for the perceived skill gap is that all those that should - in an employer's view - care for learning some skills to be used at work, don't actually have that aim during their education phase. We also suppose that such expectations could vary depending on 
 
\section{Research method}

It would be great to have one-on-one interviews with a lot of people, and ask them what they were their expectations before starting their degree and after getting it, to understand professionals' point of view, and to try to understand what teachers and university staff designing courses is actually trying to do; but, that would involve an important amount of time, both for the researchers and all the people involved.

Still, we think we can leverage modern technology to achieve something useful; we plan to \textbf{create a survey} where we ask questions to assess the thoughts of students, university teachers, and industry professionals to discover what it is, in their opinion, the current goal of university degrees (noticeable Bachelor's degrees in Computer Science, Software Engineering or whatever a similar degree is called in one's country), and how that affects job proficiency and hireability. We employ a mix of open and multiple choices questions.
...
\section{Recruitment}
Since we would like to get a good sample, we'll create a website where we describe what we are doing, and we'll provide links to the survey and an easy way to share the website itself; we'll setup a mailing list where everybody can sign up and get follow ups on our research progress and results; we hope that a bit of advertising/social media push will help us getting to the numbers we need. A lot of surveys are shared via "bare links" on SurveyMonkey or Google Forms, and we thing that leads to low engagement, because then you rarely hear back from the researchers. On the contrary, we hope that people around the world takes our effort very seriously.
 ...
 Once we collect the data, we'll graph and analyze it; we hope to find some connections between some variables that could validate or invalidate our hypothesis. While the category seems to be the low-hanging fruit, we're curious regarding the other possible independent variables, as they might expose unexpected and interesting results.
