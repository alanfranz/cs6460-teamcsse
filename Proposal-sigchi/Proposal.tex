...
\item Most employers, when hiring fresh graduates, expect they'll be able to immediately and fully carry out whatever real-world task is assigned to them.
\end{itemize}

So, our hypothesis is that one of the reasons for the perceived skill gap is that all those that should - in an employer's view - care for learning some skills to be used at work, don't actually have that aim during their education phase.
 
\section{Research method}

It would be great to have one-on-one interviews with a lot of people, and ask them what they were their expectations before and after
