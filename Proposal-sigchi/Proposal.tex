...
Since we would like to get a good sample, we'll create a website where we describe what we are doing, and we'll provide links to the survey and an easy way to share the website itself; we'll setup a mailing list where everybody can sign up and get follow ups on our research progress and results; we hope that a bit of advertising/social media push will help us getting to the numbers we need. A lot of surveys are shared via "bare links" on SurveyMonkey or Google Forms, and we thing that leads to low engagement, because then you rarely hear back from the researchers. On the contrary, we hope that people around the world takes our effort very seriously.
 ...
 Once we collect the data, we'll graph and analyze it; During our analysis, we're curious regarding the other possible independent variables, as they might expose interesting results.
